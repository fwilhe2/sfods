...
For example, consider an export of a travel budget which might look like this in CSV format:

```csv
Date,Expense,Amount Spent, % of Budget
2022-02-02,Train Ride to Berlin,97.00 €,48.50%
```
...
<spreadsheet>
  <table name="Expenses">
    ...
    <row>
      ...
      <cell type="string"> <text><![CDATA[Train Ride to Berlin]]></text> </cell>
